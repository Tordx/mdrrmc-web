    ...
    <div className="LabelWrapper">
      ...
      <div className="formlogo">
        ...
        <div className="FootForm">
          ...
          <div className="HeadForm">
              <div className="row-label">
                <label for="typeOfDisability">Type of Disability <span class="required">*</span></label>
        ...
        <div className="row-label">
          ...
          <button disabled={loading} onClick = {handleSubmit}>SUBMIT APPLICATION</button>
          </div>
