...
import RandomStringGenerator from '../components/autogeneratenumber';
    ...
    <div className='formContainer'>
       {isExpanded && (
            <div className='photo-overlay' onClick={() => setIsExpanded(false)}>
                ...
                <img src={filteredUsers[selectedPhotoIndex]?.photoURL} alt='user' style={{width: '50%', height: '50%' }} />
                </div>
            </div>
            )}
        <Header/>
                        ...
                        <tbody>
                            {filteredUsers.map((user, index) => (
                                <tr key={index}>
                                    ...
                                    <td><span>{user.street} {user.barangay}{user.barangay && ", Labrador"}</span></td>
